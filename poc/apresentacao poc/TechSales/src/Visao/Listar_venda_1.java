 ...
 * @author Alef
 */
public class Listar_venda_1 extends javax.swing.JFrame {
                ...
                if (vO.getVenCodigo() == iO.getIv_venCodigo()) {
                    ...
                    for (JogoBEAN jg : jgL) {
                        if (iO.getIv_joCodigo() == jg.getJoCodigo()) {
                            ...
                            comboBox.addItem(iO.renomear(vb, tvb, jgL));
                        }
                    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Listar_venda_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Listar_venda_1().setVisible(true);
            }
        });
    }
